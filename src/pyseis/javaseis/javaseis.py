...
from pyseis.javaseis.xml_io import JavaSeisXML
from pyseis.javaseis.templates import *  # Import all templates
from pyseis.javaseis.templates import FilePropertiesTemplate, VirtualFoldersTemplate, TraceHeadersTemplate, TraceFileTemplate
from pyseis.javaseis.js_models import build_header_struct, build_trace_struct
class ExtentManager:
